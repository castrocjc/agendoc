...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    private static final String PATIENT_NOT_AVAILABLE =
            "El paciente seleccionado no está disponible.";

    private static final String DOCTOR_NOT_AVAILABLE =
            "El médico seleccionado no está disponible.";

    private static final String AGENDA_BLOCK_NOT_AVAILABLE =
            "El bloque de agenda seleccionado no está disponible.";

    private static final String AGENDA_BLOCK_ALREADY_RESERVED =
            "El bloque de agenda seleccionado ya fue reservado.";

    private static final String INVALID_AGENDA_BLOCK_DOCTOR =
            "El bloque de agenda no corresponde al médico seleccionado.";

    private static final String PAST_APPOINTMENT =
            "No se puede crear una cita en una fecha u hora pasada.";

    private static final String INITIAL_STATUS_NOT_AVAILABLE =
